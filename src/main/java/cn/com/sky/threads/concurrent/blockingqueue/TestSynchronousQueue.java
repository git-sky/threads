 ...
 * 
 * Executors.newCachedThreadPool()就使用了SynchronousQueue，这个线程池根据需要新任务到来时）创建新的线程，如果有空闲线程则会重复使用，线程空闲了60秒后会被回收。
 * 
 * 
 */
public class TestSynchronousQueue {

	SynchronousQueue<Object> sq = new SynchronousQueue<Object>();
