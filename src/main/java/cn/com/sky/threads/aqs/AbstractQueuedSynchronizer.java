...
public abstract class AbstractQueuedSynchronizer extends AbstractOwnableSynchronizer implements java.io.Serializable {
	 ...
	 * successors(后继者) are, in part to deal with possible cancellation due to timeouts and
	 * interrupts.
	 *
	 * <p>
	...
	static final class Node {
		 ...
		 * is cancelled due to timeout or interrupt. Nodes never leave this state. In particular, a
		 ...
		 * during enqueuing, adjusted when bypassing cancelled predecessors, and nulled out (for
	 ...
	 * 
	 * 独占可中断模式，线程如果是第一个节点，尝试获取锁，失败后可能会park.
	 * 
	 * @param arg
	 *            the acquire argument
	 */
	 ...
	 *
	 * @param arg
	 *            the acquire argument. This value is always the one passed to an acquire method, or
	 ...
	 *             if acquiring would place this synchronizer in an illegal state. This exception
	 ...
	 *
	 * @param arg
	 *            the release argument. This value is always the one passed to a release method, or
	 ...
	 * @throws IllegalMonitorStateException
	 *             if releasing would place this synchronizer in an illegal state. This exception
	 *             must be thrown in a consistent fashion for synchronization to work correctly.
	 * @throws UnsupportedOperationException
	 *             if exclusive mode is not supported
	 */
	 ...
	 *
	 * @param arg
	 *            the acquire argument. This value is conveyed to {@link #tryAcquire} but is
	 ...
	 *
	 * @param arg
	 *            the release argument. This value is conveyed to {@link #tryRelease} but is
	 *            otherwise uninterpreted and can represent anything you like.
	 ...
	 *
	 * @param arg
	 *            the acquire argument. This value is conveyed to {@link #tryAcquireShared} but is
	 *            otherwise uninterpreted and can represent anything you like.
	 */
	 ...
	 *
	 * @param arg
	 *            the release argument. This value is conveyed to {@link #tryReleaseShared} but is
	 *            otherwise uninterpreted and can represent anything you like.
	...
	public class ConditionObject implements Condition, java.io.Serializable {
		...
		public final void await() throws InterruptedException {
			...
			if (acquireQueued(node, savedState) && interruptMode != THROW_IE)// 4.节点抢占锁，获取失败后放入“同步队列”，并阻塞在这里。
