 ...
 * 5，死亡状态
 *
 * 阻塞锁，可以说是让线程进入阻塞状态进行等待，当获得相应的信号（唤醒，时间到） 时，才可以进入线程的准备就绪状态，准备就绪状态的所有线程，通过竞争，进入运行状态。
 * JAVA中，能够进入\退出、阻塞状态或包含阻塞锁的方法有 ，synchronized关键字（其中的重量锁），ReentrantLock，Object.wait()\notify(),LockSupport.park()/unpart()(j.u.c经常使用)
 *
 *
 ...
 * 下面是一个JAVA 阻塞锁实例
 *
 * 在这里我们使用了LockSupport.park()的阻塞锁。
 *  该例子是将CLH锁修改而成。
 *
 * </pre>
 */
public class BlockLock implements SpinLockable {
